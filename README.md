...
int main() { float math, science, english, average; printf("Enter marks in Math, Science and English:\n"); scanf("%f %f %f", &math, &science, &english); average = (math + science + english) / 3.0;
...
### Step 8:
```
  Stop #program: #include <stdio.h>

int main() { int i, j; printf("0\n"); for (i = 7; i >= 1; i--) { for (j = i; j <= 7; j++) { printf("%d ", j); } printf("0 "); for (j = 7; j >= i; j--) { printf("%d ", j); }

    printf("\n");
}

return 0;
} #output: 0 7 0 7 6 7 0 7 6 5 6 7 0 7 6 5 4 5 6 7 0 7 6 5 4 3 4 5 6 7 0 7 6 5 4 3 2 3 4 5 6 7 0 7 6 5 4 3 2 1 2 3 4 5 6 7 0 7 6 5 4 3 2 1
```
# Result:
  Thus, the program was implemented and executed successfully, and the required output was obtained.
